...
public abstract class Document {
	...
	public double getFleschScore(){
		...
		Integer numSentences = getNumSentences();
		Integer numSyllables = getNumSyllables();
		
	    return 206.835 - 1.015 * ((float)numWords/(float)numSentences) - 84.6 * ((float)numSyllables/(float)numWords);
	}
}
